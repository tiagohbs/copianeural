...
const RankingFeature: React.FC = () => {
  ...
  return (
    <div className="flex justify-center items-center w-full min-h-[500px]">
      <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-lg border border-slate-700/50 p-8 w-full max-w-6xl" style={{ minHeight: '500px' }}>
